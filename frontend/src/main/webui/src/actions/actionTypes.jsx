...
let actionTypes = {
    ...
    JOB_PAUSE_START: 'JOB_PAUSE_START',
    JOB_PAUSE_SUCCESS: 'JOB_PAUSE_SUCCESS',
    JOB_PAUSE_ERROR: 'JOB_PAUSE_ERROR',

    JOB_RESUME_START: 'JOB_RESUME_START',
    JOB_RESUME_SUCCESS: 'JOB_RESUME_SUCCESS',
    JOB_RESUME_ERROR: 'JOB_RESUME_ERROR',
